...
**Notes:** Active development with multiple commits per week and weekly-to-bi-weekly releases (current: 0.29.0). Issues responded to within days. Active maintainer signal is the strongest signal Scorecard's `Maintained` check already grades at 10/10.
