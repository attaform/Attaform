...
export default [
  ...
  // Site Vue/TS files use their own tsconfig (extended from
  // apps/site/.nuxt/tsconfig.json — generated by `pnpm dev:prepare`).
  // The root tsconfig deliberately doesn't include apps/site so the
  // library's own typecheck stays narrow.
  {
