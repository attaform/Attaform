...
> [attaform] Form key "\_\_atta:checkout" uses the reserved "\_\_atta:" namespace. Use a different prefix: "\_\_atta:" is for library-internal synthetic keys (anonymous useForm() calls without an explicit key).
...
[injectForm](/docs/cross-cutting-state/inject-form) covers what form keys are for and how a key resolves.
