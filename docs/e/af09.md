...
condition: 'A dotted path contains an empty segment'
---
...
[setValue patterns](/docs/writing-and-mutating/set-value) covers both path forms, including the segment-tuple that sidesteps separator pitfalls.
