...
<template>
  <!-- No outer container or vertical padding: the docs layout already
       supplies the xl container and the padded content column, so the
       landing content flows straight into the column beside the
       sidebar. -->
  <div>
